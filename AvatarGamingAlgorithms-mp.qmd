...
DataM<-DataN%>%
  mutate(
    GDTTotal=GDT1+GDT2+GDT3+GDT4)%>%
  mutate(
    IGDTTotal=IGD1+IGD2+IGD3+IGD4+IGD5+IGD6+IGD7+IGD8+IGD9)%>%
  mutate(IDTotal=ID1+ID2+ID3+ID4)%>%mutate(IMTotal=IM1+IM2+IM3+IM4+IM5)%>%
  mutate(COMPTotal=COMP1+COMP2+COMP3)%>%
  mutate(PETotal=PE1+PE2+PE3+PE4+PE5+PE6)
